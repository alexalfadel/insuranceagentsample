      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection animation="scale" className="text-center">
            <motion.button
              onClick={() => onNavigate('services')}
              className="bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-xl transition-all duration-200 focus:outline-none focus-visible:outline-none active:outline-none w-1/2 mx-auto block"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
              View All Services
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <AnimatedSection animation="fadeUp" delay={0.2}>
            ...
            >
              ...
              <motion.a
              href="tel:+16505551234"
              className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 hover:bg-blue-500 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-700 cursor-pointer"
              aria-label="Call us at 650-555-1234"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.98 }}
            >
