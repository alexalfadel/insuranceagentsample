                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <AnimatedSection
                      ...
                      className="h-full"
                    >
                      <div className="bg-white border border-gray-200 rounded-2xl p-8 h-[22rem] md:h-[25rem] flex flex-col shadow-sm hover:shadow-lg transition-shadow duration-300 relative">
